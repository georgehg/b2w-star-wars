...
include::{snippets}/v1/planet-controller-test/search-planet/request-parameters.adoc[]

==== Example request

include::{snippets}/v1/planet-controller-test/search-planet/curl-request.adoc[]

==== Response Fields

include::{snippets}/v1/planet-controller-test/search-planet/response-fields.adoc[]

==== Example response

include::{snippets}/v1/planet-controller-test/search-planet/http-response.adoc[]
...
include::{snippets}/v1/planet-controller-test/delete-planet/path-parameters.adoc[]

==== Example request

include::{snippets}/v1/planet-controller-test/delete-planet/curl-request.adoc[]

==== Example response

include::{snippets}/v1/planet-controller-test/delete-planet/http-response.adoc[]
